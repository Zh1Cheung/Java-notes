...
- 一个进程从代码到二进制到运行时的一个过程
  ...
  - ![QQ截图20200805121628](C:\Users\张子恒\Desktop\QQ截图20200805121628.jpg)
- 进行编译：程序的二进制格式
...
- 一个普通线程的创建和运行过程
  - ![QQ截图20200805122912](C:\Users\张子恒\Desktop\QQ截图20200805122912.jpg)
  - 线程的数据
    - 我们把线程访问的数据细分成三类。
...
- 防止死锁
  ...
  - **3.1固定锁顺序避免死锁**
    ...
    **3.2开放调用避免死锁**
    ...
    链接：https://zhuanlan.zhihu.com/p/67570178
